      ...
      //recorremos la colección de peliculas del JSON
         ...
         for(turno of data){
            ...
            turnoRow.innerHTML = '<td>' + updateButton + '</td>' +
                    '<td class=\"td_categoria\">' + turno.fecha.toUpperCase() + '</td>' +
                    '<td class=\"td_categoria\">' + turno.paciente_id + '</td>' +
                    '<td class=\"td_categoria\">' + turno.nombrePaciente.toUpperCase() + '</td>' +
                    '<td class=\"td_categoria\">' + turno.odontologo_id + '</td>' +
                    '<td class=\"td_categoria\">' + turno.nombreOdontologo.toUpperCase() + '</td>' +
                    '<td>' + deleteButton + '</td>';
